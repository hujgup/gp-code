...
protected:
	typedef std::vector<std::tuple<std::string,PureCommand>> OptionList; // A list of menu options and the executables that should run when they are selected
private:
...
protected:
	...
	void add_option(std::string text,PureCommand cmd);
public:
